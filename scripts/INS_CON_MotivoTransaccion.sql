...
INSERT INTO `CON_MotivoTransaccion` (`CON_MotivoTransaccion_ID`,`CON_MotivoTransaccion_Codigo`,`CON_MotivoTransaccion_Descripcion`,`CON_MotivoTransaccion_FechaCreacion`,`CON_MotivoTransaccion_Fechamodificacion`) VALUES (6,'F','Devolucion Sobre Ventas',Now(),Now());
INSERT INTO `CON_MotivoTransaccion` (`CON_MotivoTransaccion_ID`,`CON_MotivoTransaccion_Codigo`,`CON_MotivoTransaccion_Descripcion`,`CON_MotivoTransaccion_FechaCreacion`,`CON_MotivoTransaccion_Fechamodificacion`) VALUES (7,'G','Descuentos',Now(),Now());
INSERT INTO `CON_MotivoTransaccion` (`CON_MotivoTransaccion_ID`,`CON_MotivoTransaccion_Codigo`,`CON_MotivoTransaccion_Descripcion`,`CON_MotivoTransaccion_FechaCreacion`,`CON_MotivoTransaccion_Fechamodificacion`) VALUES (8,'H','Venta Bono Compra',Now(),Now());
INSERT INTO `CON_MotivoTransaccion` (`CON_MotivoTransaccion_ID`,`CON_MotivoTransaccion_Codigo`,`CON_MotivoTransaccion_Descripcion`,`CON_MotivoTransaccion_FechaCreacion`,`CON_MotivoTransaccion_Fechamodificacion`) VALUES (9,'I','Impuesto Sobre la Venta',Now(),Now());