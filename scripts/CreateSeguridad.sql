...
CREATE TABLE IF NOT EXISTS `pymeERP`.`SEG_Roles` (
  ...
  `SEG_Roles_COM_NuevoEstadoOrden` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_AlmacenaEstadoOrden` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_IndexEstadoOrden` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_EditEstadoOrden` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_ListaTransiciones` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_EditaTransiciones` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_ListaEstado` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_NuevaTransicion` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_AlmacenaTransicion` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_ActualizarTransicion` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_OrdenComprasnCotizacion` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_FormOrdenComprasnCotizacion` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_GuardarOCsnCot` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_OrdenCompracnCotizacion` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_CompararCotizacion` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_OrdenCompracnCotizacionForm` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_OCcnCot` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_ListarOrdenCompra` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_AutorizarOrdenCompra` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_autorizarOrden` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_cancelarOrden` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_ListaOrdenCompra` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_AdministrarDetalle` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_AdministrarOC` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_HistorialOrdenes` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_HistorialOrden` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_GenerarPagoLC` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_DetallePago` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_GuardarPago` TINYINT(1) NULL DEFAULT 0,
  ...
  `SEG_Roles_COM_mostrarProveedorSC` TINYINT(1) NULL DEFAULT 0,
