...
CREATE TABLE IF NOT EXISTS `pymeERP`.`SEG_Roles` (
  ...
  `SEG_Roles_COM_EditarEstadoOrden` TINYINT(1) NULL DEFAULT 0,
  ...
  `SEG_Roles_COM_MostrarOrdenCompra` TINYINT(1) NULL DEFAULT 0,
  ...
  `SEG_Roles_COM_guardarAdministrarOrdenCompra` TINYINT(1) NULL DEFAULT 0,
  ...
  `SEG_Roles_COM_MostrarImprimirOrdenCompra` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_ImprimirOrdenCompra` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_VerCampoLocal` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_AgregarCampoLocal` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_EditarCampoLocal` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_EliminarCampoLocal` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_MostrarSolicitudCotizacion` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_VerCualquierProductoSC` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_VerProductoReordenSC` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_crearSolicitudCotizacion` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_EditarSolicitudCotizacion` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_DetalleSolicitudCotizacion` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_ImprimirSolicitudCotizacion` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_COM_ImpresionSolicitudCotizacion` TINYINT(1) NULL DEFAULT 0,
  ...
  `SEG_Roles_CON_ListarCatalogoContable` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_EditarCuenta` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_AgregarCuenta` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_ListarSubcuentas` TINYINT(1) NULL DEFAULT 0 COMMENT '		',
  `SEG_Roles_CON_AgregarSubcuentas` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_ListarPeriodosContables` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_AgregarPeriodoContable` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_HabilitarDeshabilitarPeriodosContables` TINYINT(1) NULL DEFAULT 0,
  ...
  `SEG_Roles_CON_ListarUnidadesMonetarias` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_ConfigurarMotivosDeInventario` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_ListarConceptosDeTransaccionesAutomaticas` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_EditarConceptosDeTransaccionesAutomaticas` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_VerLibroDiario` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_AgregarMotivoAsientosManuales` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_GenerarCierrePeriodo` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_VerPagos` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_VerReembolso` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_RealizarReembolso` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_VerEstadosFinancieros` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_ListarMotivosDeInventario` INT NULL DEFAULT 0,
  `SEG_Roles_CON_CrearAsientosContable` TINYINT(1) NULL DEFAULT 0,
  ...
  `SEG_Roles_CON_RevertirAsientosContables` TINYINT(1) NULL DEFAULT 0,
  `SEG_Roles_CON_RealizarPagos` TINYINT(1) NULL DEFAULT 0,
