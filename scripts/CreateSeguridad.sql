...
CREATE TABLE IF NOT EXISTS `pymeERP`.`SEG_Roles` (
  ...
  `SEG_Roles_COM_EditEstadoOrden` TINYINT(1) NULL,
  ...
  `SEG_Roles_INV_crearProducto` TINYINT(1) NULL,
  `SEG_Roles_INV_editarProducto` TINYINT(1) NULL,
  `SEG_Roles_INV_eliminarProducto` TINYINT(1) NULL,
  `SEG_Roles_INV_listarProducto` TINYINT(1) NULL,
  `SEG_Roles_INV_crearProveedor` TINYINT(1) NULL,
  `SEG_Roles_INV_editarProveedor` TINYINT(1) NULL,
  `SEG_Roles_INV_eliminarProveedor` TINYINT(1) NULL,
  `SEG_Roles_INV_listarProveedor` TINYINT(1) NULL,
  `SEG_Roles_INV_crearAtributo` TINYINT(1) NULL,
  `SEG_Roles_INV_editarAtributo` TINYINT(1) NULL,
  `SEG_Roles_INV_eliminarAtributo` TINYINT(1) NULL,
  `SEG_Roles_INV_listarAtributo` TINYINT(1) NULL,
  `SEG_Roles_INV_crearCategoria` TINYINT(1) NULL,
  `SEG_Roles_INV_editarCategoria` TINYINT(1) NULL,
  `SEG_Roles_INV_eliminarCategoria` TINYINT(1) NULL,
  `SEG_Roles_INV_listarCategoria` TINYINT(1) NULL,
  `SEG_Roles_INV_crearUnidadMedida` TINYINT(1) NULL,
  `SEG_Roles_INV_editarUnidadMedida` TINYINT(1) NULL,
  `SEG_Roles_INV_eliminarUnidadMedida` TINYINT(1) NULL,
  `SEG_Roles_INV_listarUnidadMedida` TINYINT(1) NULL,
  `SEG_Roles_INV_crearCiudad` TINYINT(1) NULL,
  `SEG_Roles_INV_editarCiudad` TINYINT(1) NULL,
  `SEG_Roles_INV_eliminarCiudad` TINYINT(1) NULL,
  `SEG_Roles_INV_listarCiudad` TINYINT(1) NULL,
  `SEG_Roles_INV_crearHorario` TINYINT(1) NULL,
  ...
  `SEG_Roles_INV_registrarEntradaInventario` TINYINT(1) NULL,
  `SEG_Roles_INV_registrarSalidaInventario` TINYINT(1) NULL,
  `SEG_Roles_INV_listarEntradaInventario` TINYINT(1) NULL,
  `SEG_Roles_INV_listarSalidaInventario` TINYINT(1) NULL,
  `SEG_Roles_INV_crearMotivoMovimientoInventario` TINYINT(1) NULL,
  `SEG_Roles_INV_editarMotivoMovimientoInventario` TINYINT(1) NULL,
  `SEG_Roles_INV_eliminarMotivoMovimientoInventario` TINYINT(1) NULL,
  `SEG_Roles_INV_listarMotivoMovimientoInventario` TINYINT(1) NULL,
  `SEG_Roles_INV_crearCampoLocal` TINYINT(1) NULL,
  `SEG_Roles_INV_editarCampoLocal` TINYINT(1) NULL,
  `SEG_Roles_INV_eliminarCampoLocal` TINYINT(1) NULL,
  `SEG_Roles_INV_listarCampoLocal` TINYINT(1) NULL,
  `SEG_Roles_INV_agregarProveedorProducto` TINYINT(1) NULL,
  `SEG_Roles_INV_quitarProveedorProducto` TINYINT(1) NULL,
  `SEG_Roles_INV_cambiarEstadoOrdenCompra` TINYINT(1) NULL,
  `SEG_Roles_VEN_CrearCaja` TINYINT(1) NULL,
  `SEG_Roles_VEN_AbrirCaja` TINYINT(1) NULL,
  `SEG_Roles_VEN_BorrarCaja` TINYINT(1) NULL,
  `SEG_Roles_VEN_EditarCaja` TINYINT(1) NULL,
  `SEG_Roles_VEN_VerCaja` TINYINT(1) NULL,
  `SEG_Roles_VEN_CrearPeriodoDeCierre` TINYINT(1) NULL,
  `SEG_Roles_VEN_BorrarPeriodoDeCierre` TINYINT(1) NULL,
  `SEG_Roles_VEN_EditarPeriodoDeCierre` TINYINT(1) NULL,
  `SEG_Roles_VEN_VerPeriodoDeCierre` TINYINT(1) NULL,
  `SEG_Roles_VEN_AbrirAperturaDeCaja` TINYINT(1) NULL,
  `SEG_Roles_VEN_CerrarAperturaDeCaja` TINYINT(1) NULL,
  `SEG_Roles_VEN_VerAperturaDeCierre` TINYINT(1) NULL,
  `SEG_Roles_VEN_CrearDescuentos` TINYINT(1) NULL,
  `SEG_Roles_VEN_EditarDescuentos` TINYINT(1) NULL,
  `SEG_Roles_VEN_EliminarDescuentos` TINYINT(1) NULL,
  `SEG_Roles_VEN_VerDescuentos` TINYINT(1) NULL,
  `SEG_Roles_VEN_ConfigurarVentas` TINYINT(1) NULL,
  `SEG_Roles_VEN_POSVentas` TINYINT(1) NULL,
  `SEG_Roles_VEN_EliminarProductoDeVentas` TINYINT(1) NULL,
  `SEG_Roles_VEN_EditarCantidadDeVentas` TINYINT(1) NULL,
  `SEG_Roles_VEN_GuardarVentas` TINYINT(1) NULL,
  `SEG_Roles_VEN_ListarVentas` TINYINT(1) NULL,
  `SEG_Roles_VEN_VerVentas` TINYINT(1) NULL,
