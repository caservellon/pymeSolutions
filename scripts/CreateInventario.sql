...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_Horario` ;

CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_Horario` (
  `INV_Horario_ID` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_Categoria` ;

CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_Categoria` (
  `INV_Categoria_ID` INT NOT NULL AUTO_INCREMENT,
  ...
  `INV_Categoria_Activo` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_UnidadMedida` ;

CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_UnidadMedida` (
  `INV_UnidadMedida_ID` INT NOT NULL AUTO_INCREMENT,
  ...
  `INV_UnidadMedida_Activo` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_Producto` ;
...
CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_Producto` (
  ...
  `INV_Producto_Activo` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_Atributo` ;

CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_Atributo` (
  `INV_Atributo_ID` INT NOT NULL AUTO_INCREMENT,
  ...
  `INV_Atributo_Activo` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_Producto_Atributo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_ValoresPredefinidosAtributo` ;

CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_ValoresPredefinidosAtributo` (
  `INV_ValoresPredefinidosAtributo_ID` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_Ciudad` ;

CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_Ciudad` (
  `INV_Ciudad_ID` INT NOT NULL AUTO_INCREMENT,
  ...
  `INV_Ciudad_Activo` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_Proveedor` ;

CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_Proveedor` (
  `INV_Proveedor_ID` INT NOT NULL AUTO_INCREMENT,
  ...
  `INV_Proveedor_Activo` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_Producto_Proveedor` ;
...
CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_Producto_Proveedor` (
  ...
  `INV_Producto_Proveedor_UsuarioModificacion` VARCHAR(64) NULL DEFAULT NULL,
  `INV_Producto_ID` INT NOT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_FormaPago` ;

CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_FormaPago` (
  `INV_FormaPago_ID` INT NOT NULL AUTO_INCREMENT,
  `INV_FormaPago_Nombre` VARCHAR(128) NULL DEFAULT NULL,
  `INV_FormaPago_Efectivo` INT NULL DEFAULT NULL,
  `INV_FormaPago_Credito` INT NULL DEFAULT NULL,
  ...
  `INV_FormaPago_Activo` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_Proveedor_FormaPago` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_Proveedor_CampoLocal` ;

CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_Proveedor_CampoLocal` (
  `INV_Proveedor_CampoLocal_ID` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_MotivoMovimiento` ;
...
CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_MotivoMovimiento` (
  ...
  `INV_MotivoMovimiento_Activo` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_Movimiento` ;
...
CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_Movimiento` (
  ...
  `INV_Movimiento_FechaModificacion` DATETIME NULL DEFAULT NULL,
  `INV_Movimiento_UsuarioModificacion` VARCHAR(64) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pymeERP`.`INV_DetalleMovimiento` ;

CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_DetalleMovimiento` (
  `INV_DetalleMovimiento_ID` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pymeERP`.`INV_ProductoRechazado` (
  ...
  `INV_ProductoRechazado_Activo` INT NOT NULL,
  `INV_ProductoRechazado_PrecioCosto` DECIMAL(19,2) NOT NULL,
  `INV_ProductoRechazado_PrecioVenta` DECIMAL(19,2) NOT NULL,
  `INV_ProductoRechazado_FechaCreacion` TIMESTAMP NULL,
  `INV_ProductoRechazado_UsuarioCreacion` VARCHAR(64) NULL,
  `INV_ProductoRechazado_FechaModificacion` TIMESTAMP NULL,
  `INV_ProductoRechazado_UsuarioModificacion` VARCHAR(64) NULL,
  PRIMARY KEY (`INV_ProductoRechazado_ID`),
  UNIQUE INDEX `INV_ProductoRechazado_ID_UNIQUE` (`INV_ProductoRechazado_ID` ASC),
  INDEX `OrdenCompra_Rechazado_idx` (`INV_ProductoRechazado_IDOrdenCompra` ASC),
  INDEX `Producto_Rechazado_idx` (`INV_ProductoRechazado_IDProducto` ASC),
  CONSTRAINT `OrdenCompra_Rechazado`
    FOREIGN KEY (`INV_ProductoRechazado_IDOrdenCompra`)
    REFERENCES `pymeERP`.`COM_OrdenCompra` (`COM_OrdenCompra_IdOrdenCompra`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `Producto_Rechazado`
