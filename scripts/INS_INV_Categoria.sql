...
*/
INSERT INTO `INV_Categoria` (`INV_Categoria_ID`,`INV_Categoria_Codigo`,`INV_Categoria_Nombre`,`INV_Categoria_Descripcion`,`INV_Categoria_FechaCreacion`,`INV_Categoria_UsuarioCreacion`,`INV_Categoria_FechaModificacion`,`INV_Categoria_UsuarioModificacion`,`INV_Categoria_Activo`,`INV_Categoria_IDCategoriaPadre`,`INV_Categoria_HorarioDescuento_ID`) VALUES (1,NULL,'Categoria Padre','Categoria que define las Categorias Padres',now(),substring_index(user(),'@',1),now(),substring_index(user(),'@',1),1,1,1);
