...
class Producto extends Eloquent {
	...
	public static $rules = array(
		...
		'INV_Producto_MargenGanancia' => 'required|numeric|min:0.01|regex:/[0-9]*(\.[0-9]{1,2})?$/',
		'INV_Producto_PrecioCosto' => 'required|numeric|min:0.01|regex:/[0-9]*(\.[0-9]{1,2})?$/',
		...
		'INV_Producto_TipoCodigoBarras' => 'max:64',
		'INV_Producto_ValorCodigoBarras' => 'max:14',
		'INV_Producto_ValorDescuento' => 'numeric|regex:/[0-9]*(\.[0-9]{1,2})?$/',
		'INV_Producto_PorcentajeDescuento' => 'numeric|regex:/[0-9]{1,2}(\.[0-9]{1,2})?$/',
