...
@section('main')
	...
	<div class="btn-agregar">
		<a type="button" href="{{ URL::route('ParametrizarSolicitudCotizacionCrearCampoLocal') }}" class="btn btn-default">
				...
				<tbody>
					@foreach ($editar as $editars)
						<tr>
							...
							<td>{{ link_to_route('ParametrizarSolicitudCotizacionEditarCampoLocal', 'Editar', array('id'=> $editars->GEN_CampoLocal_ID), array('class' => 'btn btn-info')) }}</td>
						</tr>
					@endforeach
                </tbody> 
             </table>
