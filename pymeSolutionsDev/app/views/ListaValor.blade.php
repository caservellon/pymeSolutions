...
@section('main')
	...
	<div class="page-header clearfix">
		<h3 class="pull-left">Configuraci&oacute;n &gt; <small>Crear Lista de Valores de Solicitud de Cotizaci&oacute;n</small></h3>
		<div class="pull-right">
			<a href="{{{ URL::to('/Compras/Parametrizar/SolicitudCotizacion') }}}" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Atr&aacute;s</a>
		</div>
	</div>
