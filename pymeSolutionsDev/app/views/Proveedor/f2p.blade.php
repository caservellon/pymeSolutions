...
@section('main')
 ...
 <div class="page-header clearfix">
      <h3 class="pull-left">Proveedor &gt; <small>Forma de Pago</small></h3>
...
<div id="f2p-view"></div>
    ...
    <div class="value-list form-group">
      ...
      <div class="col-md-5">
        ...
        {{ Form::select('INV_FormaPago_Nombre', $fpagos, null, array('class' => 'value-input form-control', 'id' => 'INV_FormaPago_Nombre')) }}
