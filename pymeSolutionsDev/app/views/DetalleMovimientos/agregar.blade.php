...
{{ Form::open(array('route' => 'Inventario.DetalleMovimiento.store', 'class' => "form-horizontal" , 'role' => 'form')) }}
    ...
    <div class="form-group">
      {{ Form::label('INV_DetalleMovimiento_PrecioCosto', 'Precio Costo:', array('class' => 'col-md-2 control-label')) }}
      <div class="col-md-5">
        {{ Form::text('INV_DetalleMovimiento_PrecioCosto',$Motivo->INV_DetalleMovimiento_PrecioCosto, array('class' => 'form-control', 'id' => 'INV_DetalleMovimiento_PrecioCosto', 'placeholder' => '#.#', 'rows' => '3' )) }}
      </div>
    </div>
    <div class="form-group">
      {{ Form::label('INV_DetalleMovimiento_PrecioVenta', 'Precio Venta:', array('class' => 'col-md-2 control-label')) }}
      <div class="col-md-5">
        {{ Form::text('INV_DetalleMovimiento_PrecioVenta',$Motivo->INV_DetalleMovimiento_PrecioVenta, array('class' => 'form-control', 'id' => 'INV_DetalleMovimiento_PrecioVenta', 'placeholder' => '#.#', 'rows' => '3' )) }}
      </div>
    </div>
