...
<h1>Edit ProveedorCampoLocal</h1>
{{ Form::model($ProveedorCampoLocal, array('method' => 'PATCH', 'route' => array('ProveedorCampoLocals.update', $ProveedorCampoLocal->id))) }}
	<ul>
        <li>
		...
		<li>
			...
			{{ link_to_route('ProveedorCampoLocals.show', 'Cancel', $ProveedorCampoLocal->id, array('class' => 'btn')) }}
		</li>
	</ul>
{{ Form::close() }}
