...
<h1>All ProveedorCampoLocals</h1>

<p>{{ link_to_route('ProveedorCampoLocals.create', 'Add new ProveedorCampoLocal') }}</p>

@if ($ProveedorCampoLocals->count())
	<table class="table table-striped table-bordered">
		...
		<tbody>
			@foreach ($ProveedorCampoLocals as $ProveedorCampoLocal)
				<tr>
...
@else
	There are no ProveedorCampoLocals
@endif
