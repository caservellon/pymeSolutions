...
<div class="well" style="max-width: 400px; margin:10px;">
	...
	<a href="/Compras/Configuracion/TransicionEstado/Editar" class="btn btn-default btn-lg btn-block"><span class="glyphicon glyphicon-usd"></span> Editar Transicion</a>
</div>
