...
<div class="well" style="max-width: 400px; margin:10px;">
	<a href="/Compras/Configuracion/Cotizacion" class="btn btn-default btn-lg btn-block"><span class="glyphicon glyphicon-plus"></span> Parametrizar Cotizacion</a>
        <a href="/Compras/Configuracion/OrdenCompra" class="btn btn-default btn-lg btn-block"><span class="glyphicon glyphicon-plus"></span> Parametrizar Orden Compra</a>
