...
<div class="row">
    <div class="page-header clearfix">
      ...
      <div class="pull-right">
        <a href="/Compras/OrdenCompra/GenerarPago/ListaCotizaciones" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Atras</a>
      </div>
</div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-md-4">
        ...
        <label>Forma de Pago</label>
         <?php  $forma= invCompras::FormaPagoCompras($ordenCompra->COM_OrdenCompra_FormaPago);// FormaPago::find($ordenCompra->COM_OrdenCompra_FormaPago);
