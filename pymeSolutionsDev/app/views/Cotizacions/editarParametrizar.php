...
<html lang="en"><head>
    ...
    <hr/>
     <div class="row">
        ...
        <div class="col-md-1 col-md-offset-7"><button type="button" class="btn btn-default btn-md">Actualizar</button></div>
    </div>
    <div class="row"> 
        ...
        <br>
         ...
         <div class="col-md-4 col-md-offset-1">
             ...
             <form class="form-inline" role="form" style="width: 1000px">
