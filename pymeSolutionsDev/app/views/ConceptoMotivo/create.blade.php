...
<h2>Concepto Motivo> <small>Crear</small>
...
{{ Form::open(array('action' => 'ConceptoMotivoController@store','class'=>'form-horizontal','role'=>'form')) }}
    ...
    <div class="form-group">
      ...
      <div class='col-md-4'>
          {{ Form::input('text', 'CON_ConceptoMotivo_Concepto','',array('maxlength'=>'45')) }}
      </div>
    </div> 
    
      <div class='col-md-3'>
			{{ Form::submit('Crear concepto motivo', array('class' => 'btn btn-success')) }}
      </div>
