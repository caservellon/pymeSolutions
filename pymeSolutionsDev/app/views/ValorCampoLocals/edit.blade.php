...
<h1>Edit ValorCampoLocal</h1>
{{ Form::model($ValorCampoLocal, array('method' => 'PATCH', 'route' => array('ValorCampoLocals.update', $ValorCampoLocal->id))) }}
	<ul>
        <li>
		...
		<li>
			...
			{{ link_to_route('ValorCampoLocals.show', 'Cancel', $ValorCampoLocal->id, array('class' => 'btn')) }}
		</li>
	</ul>
{{ Form::close() }}
